...
class Crobot_algoCtrl : public ITcOCFCtrlImpl<Crobot_algoCtrl, Crobot_algoClassFactory>
{
public:
	Crobot_algoCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("robot_algo: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<Crobot_algoCtrl>;
